...
def load_credentials(client_secret_path, token_path):
    ...
    try:
        ...
        with open(client_secret_path, 'r') as file:
            client_secret_content = file.read() #le o conteudo em base64

        client_secret_content = base64.b64decode(client_secret_content).decode('utf-8') #decodifica o base64
        ...
        if os.path.exists(token_path):
            with open(token_path, 'r') as file:
                ...
                credentials = google.oauth2.credentials.Credentials.from_authorized_user_info(
                    json.loads(token_content), # carrega o json do token
